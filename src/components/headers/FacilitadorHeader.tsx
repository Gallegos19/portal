...
const FacilitadorHeader: React.FC = () => {
  ...
  const menuItems = [
    { label: "Inicio", icon: <Home />, path: "/facilitador", key: "inicio" },
    {
      label: "Becarios",
      icon: <People />,
      path: "/facilitador/becarios",
      key: "becarios",
    },
    {
      label: "Reportes",
      icon: <Assignment />,
      path: "/facilitador/reportes",
      key: "reportes",
    },
    {
      label: "Capacitación",
      icon: <School />,
      path: "/facilitador/capacitacion",
      key: "capacitacion",
    },
    {
      label: "Fotos",
  ...
  const handleProfileClick = () => {
    navigate("/facilitador/mi-perfil");
    handleUserMenuClose();
  };
      ...
      >
        ...
        <List>
          {menuItems.map((item) => (
            ...
            >
              <ListItemIcon
                sx={{ color: isActive(item.path) ? "#26C6DA" : "#64748b" }}
              >
                {item.icon}
              </ListItemIcon>
              <ListItemText
