...
interface SubprojectosCreateDialogProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (data: Omit<Subproject, 'id'>) => Promise<void>;
  loading: boolean;
  regiones: Region[];
...
const SubprojectosCreateDialog: React.FC<SubprojectosCreateDialogProps> = ({
  open,
  onClose,
  onSubmit,
  loading,
...
export default SubprojectosCreateDialog;
