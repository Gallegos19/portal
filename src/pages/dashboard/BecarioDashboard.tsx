...
const BecarioDashboard: React.FC = () => {
  return (
    <>
      {/* Contenido Principal */}
        ...
        <Box sx={{ 
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography variant="body1" sx={{ 
              ...
              Estamos aquí para facilitar la organización y el acceso a la información de manera sencilla y eficiente. Juntos, construimos un futuro más conectado y solidario. 😊
            </Typography>
